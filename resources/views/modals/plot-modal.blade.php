    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content light-grey">
            <div class="modal-header">
                ...
                <button id="plot-modal-close-button" type="button" class="close" data-dismiss="modal"
                    aria-label="Close">
                        ...
                        <div class="col-4">
                            ...
                            <div id="plot-modal-selectionPlots">
                                @foreach ($selectionPlots as $selectionPlot)
                                    <p class="m-0" onclick="pickPlotCard('{{$loop->index}}')"><a class="text-light">{{ $selectionPlot['name'] }}:
